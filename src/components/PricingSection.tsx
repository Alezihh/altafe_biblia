        ...
        <div className="rounded-[32px] bg-white shadow-[0_35px_80px_rgba(0,0,0,0.35)] overflow-hidden">
          ...
          <div className="px-6 py-10 md:px-12 md:py-12">
            ...
            <div className="mb-8 text-center">
              <p className="mb-2 text-3xl md:text-4xl font-semibold line-through text-red-600">DE R$199,90</p>
              <p className="mb-2 text-xl md:text-2xl font-semibold text-black">POR APENAS</p>
              <p className="mb-2 text-7xl md:text-8xl font-bold text-[#1fa347]">R$ 29,90</p>
              <p className="text-base md:text-lg font-semibold text-black underline">Oferta Única - Seja Rápido</p>
            </div>
